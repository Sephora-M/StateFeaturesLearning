...
class Model(object):
    ...
    def build(self, hidden1, hidden2, hidden3=None):
        """ Wrapper for _build() """
        with tf.variable_scope(self.name):
            self._build(hidden1, hidden2, hidden3=None)
...
class GCNModelAE(Model):
    def __init__(self, placeholders, num_features, features_nonzero, hidden1, hidden2, hidden3, **kwargs):
        ...
        self.build(hidden1, hidden2, hidden3)
