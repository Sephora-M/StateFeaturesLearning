...
flags.DEFINE_integer('hidden3', 2, 'Number of units in hidden layer 3.')
...
def get_roc_score(edges_pos, edges_neg, emb=None):
    ...
    return roc_score, ap_score, emb, adj_rec
...
for epoch in range(FLAGS.epochs):
    ...
    roc_curr, ap_curr, embedding_train, adj_training = get_roc_score(val_edges, val_edges_false)
